...
- "doi_chieu_tm_so_lieu": TẤT CẢ nội dung liên quan BCĐKT/BCKQKD/BCLCTT/Thuyết minh — đối chiếu TM hai chiều (Mục 7.4), tính toán lại (Mục 11.1), cross-check ngang giữa 3 mặt báo cáo (Mục 11.2), cross-check dọc mặt BC ↔ Thuyết minh (Mục 11.3-11.5), bảng biến động (Mục 11.6), gap analysis (Mục 11.7), note thuế TNDN (Mục 11.8), chính sách doanh thu (Mục 10), tiêu đề cột/format riêng của 3 báo cáo này. Đây là nhóm lớn nhất, gộp chung toàn bộ số liệu tài chính — KHÔNG bao gồm Mục 11A (xem group riêng "kiem_tra_logic" bên dưới).
- "erc_irc": Đối chiếu ERC/IRC cơ bản (Mục 9).
- "kiem_tra_logic": Kiểm tra logic số liệu BCTC ↔ Thuyết minh (Mục 11A) — khớp tổng chi tiết nội bộ note, dấu âm/dương, phân loại ngắn/dài hạn, nối tiếp số dư đầu/cuối kỳ, liên kết chéo giữa các note, và đặc biệt Mục 11A.7 (bộ quy tắc R1–R36 đối chiếu BCLCTT ↔ thuyết minh theo 7 nhóm: LN trước thuế; điều chỉnh phi tiền 02-07; thay đổi vốn lưu động 09-17; hoạt động đầu tư 21-27; hoạt động tài chính 31-36; tiền & tương đương tiền 50/60/61/70; tính đầy đủ & đếm trùng R33-R36) — ĐÂY LÀ MỘT GROUP RIÊNG, không gộp vào "doi_chieu_tm_so_lieu" dù cùng liên quan số liệu, để người dùng thấy rõ phần kiểm tra logic sâu này trong bảng kết quả.
