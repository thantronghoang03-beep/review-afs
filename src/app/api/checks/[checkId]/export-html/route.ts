...
import { generateHtmlReport } from "@/lib/export/html-report";
...
export async function GET(_req: Request, ctx: Params) {
  ...
  const html = generateHtmlReport(check, findings);

  return new NextResponse(html, {
    headers: {
      "Content-Type": "text/html; charset=utf-8",
      "Content-Disposition": `attachment; filename="bao-cao-${checkId}.html"`,
    },
  });
}
